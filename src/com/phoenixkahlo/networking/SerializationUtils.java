...
public class SerializationUtils {
	...
	/**
	 * @param the type of object to decode
	 * @param decoder the decoder to use if the type is not primitive, String, or byte[]. may be null
	 * @throws IllegalArgumentException if the type is unreadable by SerializationUtils and decoder
	 */
	public static Object readType(Class<?> type, InputStream in, DecodingProtocol decoder)
	...
	/**
	 * @param encoder the encoder to use if the type is not primitive, String, or byte[]. may be null
	 * @throws IllegalArgumentException of encoder throws it or if type not encodable by
